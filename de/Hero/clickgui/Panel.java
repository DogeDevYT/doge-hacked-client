...
public class Panel {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if(Doge.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("New")){
		...
		}else if(Doge.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike")){
		...
		if (this.extended && !Elements.isEmpty()) {
			...
			int epanelcolor = Doge.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("New") ? 0xff232323 : Doge.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike") ? 0xbb151515 : 0;
